...
public final class ActivityPrincipalBinding implements ViewBinding {
  ...
  @NonNull
  public final Button jugar;

  private ActivityPrincipalBinding(@NonNull ConstraintLayout rootView, @NonNull Button jugar) {
  ...
  public static ActivityPrincipalBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.jugar;
      Button jugar = ViewBindings.findChildViewById(rootView, id);
      if (jugar == null) {
        break missingId;
      }

      return new ActivityPrincipalBinding((ConstraintLayout) rootView, jugar);
    }
